//Emitir_relatorio_ATV_WF.js

//Robô para emissão de relatório do WF da Claro utilizando senha de terceiros
...
async function main() {
    ...
    // 2. Calculando o último dia do mês anterior
        const hoje = new Date();
    ...
    // 2. Selecionando o ultimo dia do mês anterio de forma dinâmica
    ...
    console.log(' ');
    console.log('Emitindo relatório, por favor aguarde...');
